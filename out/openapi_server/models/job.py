...
class Job(Model):
    ...
    def __init__(self, job_id=None, creator_user_name=None, run_as_user_name=None, settings=None, created_time=None):  # noqa: E501
        ...
        :type job_id: int
        :param creator_user_name: The creator_user_name of this Job.  # noqa: E501
        :type creator_user_name: str
        :param run_as_user_name: The run_as_user_name of this Job.  # noqa: E501
    ...
    def creator_user_name(self, creator_user_name):
        """Sets the creator_user_name of this Job.

        The creator user name. This field won’t be included in the response if the user has already been deleted.  # noqa: E501

        :param creator_user_name: The creator_user_name of this Job.
        :type creator_user_name: str
        """
    ...
    def run_as_user_name(self):
        """Gets the run_as_user_name of this Job.
        ...
        :return: The run_as_user_name of this Job.
        :rtype: str
        """
    ...
    def run_as_user_name(self, run_as_user_name):
        """Sets the run_as_user_name of this Job.

        The user name that the job runs as. `run_as_user_name` is based on the current job settings, and is set to the creator of the job if job access control is disabled, or the `is_owner` permission if job access control is enabled.  # noqa: E501

        :param run_as_user_name: The run_as_user_name of this Job.
        :type run_as_user_name: str
        """
